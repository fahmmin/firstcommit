      ...
      <header className="flex items-center justify-between px-6 py-3 bg-white/80 border-b border-slate-200">
        <div className="flex items-center gap-3">
          <a href="#/" className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-2xl bg-brand text-white grid place-items-center font-bold group-hover:scale-105 transition">स</div>
            <div>
        ...
        <div className="flex items-center gap-2">
          <a href="#/docs" className="text-xs px-3 py-1.5 rounded-full border border-slate-300 hover:bg-slate-100">Docs</a>
